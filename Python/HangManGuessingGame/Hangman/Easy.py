...
class Easy(Window):
    ...
    def __init__(self,settings):
        _wpf.LoadComponent(self, 'Easy.xaml')
        self.ButtonArray = [self.Button1,self.Button2,self.Button3,self.Button4,self.Button5,self.Button6,self.Button7,self.Button8,self.Button9,self.Button10,self.Button11,self.Button12]
        self.bw = retrieveWord(settings)
        self.Settings = settings
        self.tba = [self.T1,self.T2,self.T3,self.T4,self.T5,self.T6]  
        self.LP = 5
