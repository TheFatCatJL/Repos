...
class Hard(Window):
    def __init__(self,settings):
        _wpf.LoadComponent(self, 'Hard.xaml')
        self.ButtonArray = [self.Button1,self.Button2,self.Button3,self.Button4,self.Button5,self.Button6,self.Button7,self.Button8,self.Button9,self.Button10,self.Button11,self.Button12,self.Button13,self.Button14,self.Button15,self.Button16,self.Button17,self.Button18,self.Button19,self.Button20]
        self.bw = retrieveWord(settings)
        self.Settings = settings
        self.tba = [self.T1,self.T2,self.T3,self.T4,self.T5,self.T6,self.T7,self.T8,self.T9,self.T10]          
        self.LP = 5
    ...
    def Button17_Click(self, sender, e):
        self.Button17.IsEnabled = False
        checkBaseword(self.Button17.Content,self.bw, self.tba,self.LifeLabel.Content,self.LifeLabel,self.hms,self.ButtonArray)
    
    def Button18_Click(self, sender, e):
        self.Button18.IsEnabled = False
        checkBaseword(self.Button18.Content,self.bw, self.tba,self.LifeLabel.Content,self.LifeLabel,self.hms,self.ButtonArray)
    
    def Button19_Click(self, sender, e):
        self.Button19.IsEnabled = False
        checkBaseword(self.Button19.Content,self.bw, self.tba,self.LifeLabel.Content,self.LifeLabel,self.hms,self.ButtonArray)
    
    def Button20_Click(self, sender, e):
        self.Button20.IsEnabled = False
        checkBaseword(self.Button20.Content,self.bw, self.tba,self.LifeLabel.Content,self.LifeLabel,self.hms,self.ButtonArray)
